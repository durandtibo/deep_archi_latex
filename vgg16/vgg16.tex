...
%     {\includegraphics[width=\cubey cm]{../image/003348_2}};
...
%\draw[red] (\x+\xx/2,\cubey/2,\cubez/2) circle[radius=2pt];
%\draw[blue] (\x+\xx/2-\cubex-\xx,\cubey/2,\cubez/2) circle[radius=2pt];
%\draw[green] (\x+\xx/2-\xx,\cubey/2,\cubez/2-\cubez) circle[radius=2pt];
